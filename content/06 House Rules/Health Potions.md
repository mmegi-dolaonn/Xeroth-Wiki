...
1) Instead of using an action to roll the amount of health you recover from a healing potion, you can instead make a choice. Either:
    - Use an Action to restore the maximum amount of possible health that could be rolled.
    - Use a Bonus Action to roll the amount of health you recover.
2) Using a health potion no longer consumes your free item interaction on your turn.

All other potions function as written.